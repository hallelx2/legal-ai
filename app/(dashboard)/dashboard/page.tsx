...
export default function Dashboard() {
  ...
  const quickStats = [
    { label: 'Active Agreements', value: '12', icon: FileText, trend: '+3 this month' },
    { label: 'Pending Signatures', value: '5', icon: FileSignature, trend: '2 urgent' },
    { label: 'Completed This Month', value: '8', icon: CheckCircle2, trend: '+15% vs last month' },
    { label: 'Team Members', value: '6', icon: Users, trend: '2 new this week' }
  ];
  ...
  const recentActivity = [
    ...
    },
    {
      ...
      description: 'Service Agreement sent to Legal Solutions Inc for signature',
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-4">
          <Button variant="secondary" onClick={() => router.push('/dashboard/agreements')}>
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                <button className="w-full flex items-center p-3 text-left rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-medium text-gray-900">Create Agreement</p>
                ...
                <button className="w-full flex items-center p-3 text-left rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-medium text-gray-900">Send for Signature</p>
                    <p className="text-xs text-gray-500">Get your document signed</p>
                  </div>
                </button>
                <button className="w-full flex items-center p-3 text-left rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-gray-500">Add or remove members</p>
                  </div>
                </button>
              </div>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-500">Agreements Created</span>
