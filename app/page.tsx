  ...
  const features = [
    {
      ...
      description: 'Create and customize your own templates with our intuitive drag-and-drop builder. Add dynamic fields, conditional logic, and signature blocks.'
    },
    {
      icon: <FileSignature className="h-8 w-8 text-indigo-600" />,
      title: 'DocuSign Integration',
      description: 'Seamless integration with DocuSign for secure, legally-binding electronic signatures. Track status and get instant notifications.'
    },
    {
      icon: <Eye className="h-8 w-8 text-indigo-600" />,
      title: 'Real-time Monitoring',
      description: 'Track document status, view signature progress, and manage all your agreements from a single dashboard.'
    },
    {
      icon: <MessageSquare className="h-8 w-8 text-indigo-600" />,
      title: 'AI Assistant',
      description: 'Get instant help with our AI chatbot for template selection, document creation, and process guidance.'
    }
  ];
  ...
  const workflowSteps = [
    {
      ...
      description: 'Choose from pre-built templates or create your own custom template using our intuitive builder.'
    },
    {
      icon: <PenTool className="h-12 w-12 text-indigo-600" />,
      title: 'Customize Content',
      description: 'Fill in dynamic fields, add clauses, and customize terms to match your specific needs.'
    },
    {
      icon: <Mail className="h-12 w-12 text-indigo-600" />,
      title: 'Send for Signature',
      description: 'Send documents for signature via DocuSign with automatic email notifications and reminders.'
    },
    {
      icon: <Eye className="h-12 w-12 text-indigo-600" />,
      title: 'Track Progress',
      description: 'Monitor signature status, view audit trails, and manage the entire process from your dashboard.'
    }
  ];

  const testimonials = [
    {
      quote: "The combination of custom templates and DocuSign integration has revolutionized how we handle contracts. The AI assistant makes the whole process incredibly smooth.",
    ...
    {
      quote: "Being able to create custom templates and monitor signatures in real-time has cut our contract completion time by 80%. The chatbot is incredibly helpful.",
      author: "Michael Chen",
    ...
    {
      quote: "The platform's DocuSign integration and real-time tracking make managing hundreds of agreements effortless. It's transformed our legal operations.",
  ...
  return (
    ...
    <div className="flex flex-col min-h-screen">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-white/90 leading-relaxed backdrop-blur-sm">
                  Build custom templates, generate agreements, and manage DocuSign signatures all in one platform. Get help from our AI assistant at every step.
                </p>
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900">Trusted by Legal Teams</h2>
            <p className="mt-4 text-xl text-gray-600">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-500 to-teal-500 p-12">
            ...
            <div className="relative text-center">
              ...
              <p className="text-xl text-indigo-100 mb-8">
                Start creating and managing agreements with DocuSign integration today
              </p>
